...
def create_nfs_export(client, fs_name, nfs_name, nfs_export_name, path, index):
...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        for i in range(1, 5):
            ...
            create_nfs_export(clients[0], fs_name, nfs_name, nfs_export_name, path, i)
